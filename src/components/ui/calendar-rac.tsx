  ...
  return (
    ...
    >
      <header className="flex items-center justify-between pb-4 px-1">
        <Button slot="previous" className="w-8 h-8 flex items-center justify-center rounded-md hover:bg-accent hover:text-accent-foreground outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2">
          <ChevronLeft className="w-4 h-4" />
        </Button>
        <Heading className="font-semibold text-sm" />
        <Button slot="next" className="w-8 h-8 flex items-center justify-center rounded-md hover:bg-accent hover:text-accent-foreground outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2">
      ...
      <CalendarGrid className="border-collapse space-y-1">
        ...
        <CalendarGridBody className="space-y-1">
          {(date) => (
            <CalendarCell
              date={date}
              className={({ isSelected, isHovered, isFocusVisible, isOutsideMonth }) =>
                twMerge(
                  "h-9 w-9 text-center text-sm p-0 relative flex items-center justify-center rounded-md outline-none cursor-default",
                  isOutsideMonth ? "text-muted-foreground opacity-50" : "text-foreground",
