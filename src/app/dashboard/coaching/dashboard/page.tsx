      ...
      const updatedSessions = upcomingSessions.map((session) => {
        if (session.id === selectedSession.id) {
          ...
          return {
            ...
            endTime: end,
            date: format(startDate, "EEE, MMM d, yyyy"),
            time: `${format(startDate, "h:mm a")} - ${format(
              endDate,
              "h:mm a"
            )}`,
            status: "rescheduled",
          ...
          >
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
              ...
              <TabsList className="bg-gray-100/50 p-1.5 rounded-2xl">
                <TabsTrigger
                  value="upcoming"
                  className="rounded-xl px-6 py-2.5 text-sm font-medium data-[state=active]:bg-white data-[state=active]:shadow-sm data-[state=active]:text-black transition-all"
                >
                  Upcoming
                </TabsTrigger>
                <TabsTrigger
              ...
              {upcomingSessions.length > 0 ? (
                upcomingSessions.map((session, index) => (
                  ...
                  >
                    <div className="flex items-center gap-5 flex-1 w-full">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-3">
                          <Badge
                            variant="secondary"
                            className="font-medium bg-blue-50 text-blue-700 hover:bg-blue-100 border-none px-3 py-1 rounded-lg"
                          >
                            {session.topic}
                          </Badge>
                    ...
                    <div className="flex gap-3 w-full md:w-auto pt-2 md:pt-0">
                      ...
                      <Button
                        className="flex-1 md:flex-none bg-black text-white hover:bg-gray-900 shadow-lg shadow-black/10 h-11 px-6 rounded-xl font-medium transition-all hover:scale-105"
                        asChild
                      >
                        <a
                ...
                <div className="text-center py-20 bg-gray-50/30 rounded-3xl border-2 border-dashed border-gray-200">
                  ...
                  <p className="text-gray-500 max-w-sm mx-auto">
                    You don't have any scheduled sessions yet. Share your
                    profile to get booked!
                  </p>
                </div>
              )}
            </TabsContent>
                  ...
                  >
                    ...
                    <div className="flex gap-3 w-full md:w-auto pt-2 md:pt-0">
                      <Button
                        variant="ghost"
                        size="sm"
                        className="text-gray-500 hover:text-gray-900 h-10 px-4 rounded-xl"
                      >
            ...
            <div className="space-y-6 py-4">
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  >
                    <AriaLabel className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
                      New Date
                    </AriaLabel>
                    <div className="flex">
