        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12 animate-in fade-in slide-in-from-top-4 duration-700">
          <div className="space-y-2">
            <h1 className="text-4xl sm:text-5xl font-extrabold text-gray-900 tracking-tight">
              Profile & <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Identity</span>
            </h1>
            <p className="text-lg text-gray-500 font-medium max-w-xl">
              Manage your public presence. A complete profile helps students trust and connect with you.
            </p>
          </div>
           ...
           <div className="lg:col-span-4 space-y-6 lg:sticky lg:top-8 animate-in fade-in slide-in-from-left-4 duration-700 delay-100">
              ...
              <div className="bg-white/80 backdrop-blur-2xl rounded-[2rem] border border-white/60 shadow-xl shadow-blue-900/5 flex flex-col items-center text-center relative overflow-hidden group">
                 ...
                 <div className="relative mt-16 mb-6">
                    <div className="h-40 w-40 rounded-full p-1.5 bg-white shadow-2xl ring-4 ring-blue-50/50 overflow-hidden relative group-hover:scale-105 transition-transform duration-500 cubic-[0.34,1.56,0.64,1]">
                        <Avatar className="h-full w-full border-4 border-white">
                          <AvatarImage src={avatarPreview || user.image || user.avatar || `/api/users/${user.id}/avatar`} className="object-cover" />
                 ...
                 <div className="px-8 pb-8 w-full">
                    <h2 className="text-2xl font-bold text-gray-900 mb-1">{profileData.name || "Your Name"}</h2>
                    ...
                    <div className="space-y-3 w-full">
                        ...
                        {profileData.location && (
                          <div className="flex items-center gap-3 text-sm text-gray-600 bg-gray-50/80 p-3 rounded-2xl border border-gray-100 transition-colors hover:bg-purple-50/50 hover:border-purple-100 group/item">
                             ...
                             <span className="truncate font-medium">{profileData.location}</span>
                          </div>
                        )}
                    </div>
                    ...
                    <div className="mt-8 pt-6 border-t border-gray-100">
                       <div className="flex justify-between items-center mb-2">
                          ...
                          <span className={`text-xs font-bold ${completionPercentage === 100 ? 'text-green-500' : 'text-blue-500'}`}>{completionPercentage}%</span>
                       </div>
                       <div className="h-2 w-full bg-gray-100 rounded-full overflow-hidden">
                          <div 
                            className={`h-full rounded-full transition-all duration-1000 ease-out ${completionPercentage === 100 ? 'bg-green-500' : 'bg-gradient-to-r from-blue-500 to-purple-500'}`}
                            style={{ width: `${completionPercentage}%` }}
                          />
                       </div>
                       {completionPercentage < 100 && (
                         <p className="text-xs text-gray-400 mt-2 font-medium">Add more details to reach 100%</p>
                       )}
                    </div>
                 </div>
              </div>
              ...
              <div className="bg-white/80 backdrop-blur-2xl rounded-[2rem] border border-white/60 shadow-xl shadow-blue-900/5 p-8 sm:p-10">
                 <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                        ...
                        <p className="text-gray-500 text-sm">Correct information helps verify your identity.</p>
                    </div>
                 </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                    ...
                    <div className="col-span-1 md:col-span-2 space-y-2">
                       <Label className="text-sm font-bold text-gray-700 ml-1">About You</Label>
                       <Textarea
                       ...
                       />
                       <p className="text-right text-xs text-gray-400 font-medium">{(profileData.bio?.length || 0)} / 500 characters</p>
                    </div>
                    ...
                    <div className="bg-gray-50 rounded-2xl p-6 col-span-1 md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6 border border-gray-100">
                        <div className="space-y-2">
                          <Label className="text-xs font-bold text-gray-500 uppercase tracking-widest ml-1">Email (Private)</Label>
                        ...
                        <div className="space-y-2">
                          <Label className="text-xs font-bold text-gray-500 uppercase tracking-widest ml-1">Phone (Private)</Label>
                          <div className="relative group">
              ...
              <div className="bg-white/80 backdrop-blur-2xl rounded-[2rem] border border-white/60 shadow-xl shadow-blue-900/5 p-8 sm:p-10">
                 <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                        ...
                        <p className="text-gray-500 text-sm">Where can students find more about you?</p>
                    </div>
                 </div>

                 <div className="space-y-5">
                    <div className="space-y-2">
                      <Label className="text-sm font-bold text-gray-700 ml-1">Personal Website</Label>
                      <div className="relative group">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-2">
                          <Label className="text-sm font-bold text-gray-700 ml-1">Twitter / X</Label>
                          <div className="relative group">
