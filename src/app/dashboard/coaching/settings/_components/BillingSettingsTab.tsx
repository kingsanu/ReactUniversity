                  ...
                  /* Loading State */
                   Array.from({ length: 5 }).map((_, i) => (
                    <TableRow key={i} className="border-b border-gray-50">
                       <TableCell className="pl-6"><div className="h-4 w-32 bg-gray-100 rounded animate-pulse" /></TableCell>
                       ...
                       <TableCell className="pr-6"><div className="h-8 w-8 bg-gray-100 rounded-full ml-auto animate-pulse" /></TableCell>
                    </TableRow>
                   ))
