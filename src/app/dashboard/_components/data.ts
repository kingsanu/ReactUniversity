...
export const sidebarData = {
  ...
  navigation: [
    ...
    },
    {
      ...
      submenu: [
        { name: "Overview", path: "/dashboard/assessments" },
        { name: "PCA Assessment", path: "/dashboard/assessments/pca" },
        { name: "LIA Assessment", path: "/dashboard/assessments/mil" },
        { name: "360 Evaluation", path: "/dashboard/assessments/evaluation" },
