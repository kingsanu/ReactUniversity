...
import { ProfileAssessmentStep } from "./_components/ProfileAssessmentStep";
import { TemplateRecommendationStep } from "./_components/TemplateRecommendationStep";
...
export default function ResumeBuilderPage() {
  ...
  const renderCurrentStep = () => {
    switch (currentStep) {
      case 1:
        return <ProfileAssessmentStep />;
      case 2:
        return <TemplateRecommendationStep />;
      case 3:
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 lg:py-8">
        {currentStep <= 2 ? (
          // Full width for first 2 steps (Profile Assessment and Template Selection)
          <div className="max-w-6xl mx-auto">
            <div className="bg-white/70 backdrop-blur-xl rounded-2xl shadow-xl border border-white/20 p-4 sm:p-6 lg:p-8">
              {renderCurrentStep()}
              <NavigationButtons />
            </div>
          </div>
        ) : (
          // Responsive layout for steps 3+ with live preview
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 lg:gap-8">
            ...
            <div className="bg-white/70 backdrop-blur-xl rounded-2xl shadow-xl border border-white/20 p-4 sm:p-6 lg:p-8">
              ...
              {/* Mobile Preview */}
              {showMobilePreview && (
                <div className="xl:hidden mb-6 bg-gray-50 rounded-xl p-4 border border-gray-200">
            ...
            {/* Live Preview Section - Hidden on mobile, shown on larger screens */}
