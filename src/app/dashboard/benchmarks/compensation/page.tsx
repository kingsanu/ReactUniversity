...
import { DollarSign, TrendingUp, AlertCircle, Home, ShoppingBag, CreditCard } from "lucide-react";
...
export default function CompensationPage() {
  ...
  const averageSalary = salaryData.find(s => s.role === "Mid-Level")?.avg || 0;
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="bg-gradient-to-br from-emerald-500 to-emerald-600 text-white border-none shadow-md">
           <CardContent className="p-6">
             <div className="flex justify-between items-start">
               <div>
                  <p className="text-emerald-100 font-medium text-sm">Avg. Annual Salary</p>
             ...
             <div className="mt-4 flex items-center text-emerald-100 text-sm">
               ...
               <span className="font-semibold mr-1">+{growthRate}%</span> since last year
             </div>
           </CardContent>
        </Card>
        ...
        <Card className="bg-white border-slate-200 shadow-sm">
           <CardContent className="p-6">
             <div className="flex justify-between items-start">
               <div>
                  <p className="text-slate-500 font-medium text-sm">Purchase Power Index</p>
                  <h3 className="text-3xl font-bold mt-2 text-slate-900">
                    {loading || !colData ? "..." : (100 - colData.purchasingPower).toFixed(1)}
                  </h3>
               </div>
         ...
         <Card className="bg-white border-slate-200 shadow-sm">
           <CardContent className="p-6">
             <div className="flex justify-between items-start">
                <div>
                  <p className="text-slate-500 font-medium text-sm">Est. Take Home</p>
                  <h3 className="text-3xl font-bold mt-2 text-slate-900">
                    {loading ? "..." : `$${(averageSalary * 0.72 / 1000).toFixed(1)}k`}
                  </h3>
               </div>
               <div className="p-2 bg-slate-100 rounded-lg">
        ...
        <div className="lg:col-span-2 space-y-8">
          <Card className="shadow-sm border-slate-200">
            <CardHeader>
              ...
              <CardDescription>
                Compensation ranges for {career} roles in {country} across experience levels.
              </CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <div className="mt-6 p-4 bg-slate-50 rounded-lg border border-slate-100">
                ...
                <p className="text-sm text-slate-600 leading-relaxed">
                  Salary bands for {career} in {country} are widening. Senior-level roles are seeing faster growth due to a shortage of specialized talent, while entry-level compensation remains stable.
                </p>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="space-y-6">
           <Card className="shadow-sm border-slate-200">
            <CardHeader>
              ...
              <CardDescription>Economic impact on real earnings</CardDescription>
            </CardHeader>
            <CardContent>
