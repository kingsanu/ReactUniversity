  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
       ...
       <div className="flex flex-col md:flex-row justify-between items-end border-b border-slate-200 pb-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-900">Workforce & Culture</h2>
          <p className="text-slate-500 mt-1">
            Demographic breakdown and work environment trends.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <Card className="shadow-sm border-slate-200 h-full">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
               ...
               <CardDescription>
                Prevalence of Remote vs Hybrid vs Onsite roles.
              </CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <div className="mt-8 grid grid-cols-3 gap-2 text-center">
                 <div className="p-3 bg-slate-50 rounded-lg">
                   ...
                   <p className="text-xs text-slate-500 font-medium uppercase tracking-wide">Remote</p>
                 </div>
                 <div className="p-3 bg-slate-50 rounded-lg">
                   <h4 className="text-2xl font-bold text-slate-900">45%</h4>
                    <p className="text-xs text-slate-500 font-medium uppercase tracking-wide">Hybrid</p>
                 </div>
                 <div className="p-3 bg-slate-50 rounded-lg">
                   <h4 className="text-2xl font-bold text-slate-900">20%</h4>
                    <p className="text-xs text-slate-500 font-medium uppercase tracking-wide">Onsite</p>
                 </div>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="space-y-6">
          <Card className="shadow-sm border-slate-200">
            <CardHeader>
              ...
              <CardDescription>
                Gender distribution in {career} roles.
              </CardDescription>
            </CardHeader>
            <CardContent>
           ...
           <Card className="shadow-sm border-slate-200 bg-slate-900 text-white">
            ...
            <CardContent>
               ...
               <p className="text-sm text-slate-300">
                 Industry average rating for inclusive workplace policies and benefits.
               </p>

               <div className="mt-4 flex flex-wrap gap-2">
                  <Badge variant="secondary" className="bg-white/10 text-white hover:bg-white/20">Parental Leave</Badge>
                  <Badge variant="secondary" className="bg-white/10 text-white hover:bg-white/20">Flex Hours</Badge>
                  <Badge variant="secondary" className="bg-white/10 text-white hover:bg-white/20">Wellness Pgms</Badge>
               </div>
            </CardContent>
          </Card>
        </div>
       ...
       <div className="p-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between gap-4">
         <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="font-semibold text-blue-900">Enterprise Trend</h3>
              <p className="text-sm text-blue-700">Fortune 500 companies are shifting 20% more roles to "Remote-First" in 2025.</p>
            </div>
         </div>
         <Badge className="bg-blue-600 hover:bg-blue-700">Read Report</Badge>
       </div>
    </div>
  );
}
